    ...
    for epoch_id in range(1, self.num_epochs + 1):
      ...
      for batch_id, batch in enumerate(iterate_minibatches(
        ...
        fetches = {
          ...
          "yp"          : self.model.y_p,
          "yp_shaped1"  : self.model.yp_shaped1,
          "yp_shaped"   : self.model.yp_shaped,
          "yp_embedded" : self.model.yp_embedded,
          "xp_shaped1"  : self.model.xp_shaped1,
          "xp_shaped2"  : self.model.xp_shaped2,
          "xp_shaped"   : self.model.xp_shaped,
          "xp_embedded" : self.model.xp_embedded,
          "concatted"   : self.model.concatted,
          "embedded"    : self.model.embedded,
        }
