...
class NeuralIBM1Model:
  ...
  def _build_model(self):
    ...
    # Reshape py_xa from [B * M, y_vocab] into [B, M, y_vocab]
    ...
    cross_entropy = tf.nn.sparse_softmax_cross_entropy_with_logits(
      labels=tf.reshape(self.y, [-1]), # this flattens self.y! into [batch_size * longest_y]
